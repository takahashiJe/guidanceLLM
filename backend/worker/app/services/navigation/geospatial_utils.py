...
def calculate_distance_from_route(
    ...
    try:
        ...
        # 不正なGeoJSONや座標データが渡された場合のエラーハンドリング
...
def calculate_distance_between_points(
    ...
    Returns:
        float: 2点間の距離（メートル単位）。エラー時は無限大を返す。
    """
    try:
        # pyprojライブラリを使い、地球の曲率を考慮した正確な距離を計算
        _, _, distance_meters = geod.inv(
